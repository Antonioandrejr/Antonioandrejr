...
def self_checkout_cashier(cashier_id, customers):
    print(f"Self-checkout  {cashier_id} starts processing.")
    for customer in customers:
        process_customer(cashier_id, customer)
    print(f"Self-checkout  {cashier_id} has finished processing.")
...
def   main():
    num_customers = int(input('\nEnter total number of customers:')) # Total number of customers
    num_self_checkout_lanes = 4 # Number of self-checkout lanes
